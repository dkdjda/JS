...
const infoTag = (main) => ` <div class="box one">
        <img src="${main.image}" alt="" />
        <div class="info">
          <span class="name">${main.firstName}${main.maidenName}${main.lastName}</span>
          <span class="birthDate">${main.birthDate}</span>
          <span class="department">${main.department}</span>
          <span class="email">${main.email}</span>
        </div>
      </div>
      ...
      <div class="box two">
        ...
        <div class="info">
          <span class="name">${main.firstName}${main.maidenName}${main.lastName}</span>
          <span class="birthDate">${main.birthDate}</span>
          <span class="department">${main.company.department}</span>
          <span class="email">${main.email}</span>
        </div>
      </div>`;
