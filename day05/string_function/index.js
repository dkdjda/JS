...
coffee.slice(0, 5); //역할 : 글자 0번부터 4까지 돌려줌,결과값 : string
...
coffee.toLocaleLowerCase(); //역할 : 대문자화, 결과값 : string
coffee.toLocaleUpperCase(); //역할 : 소문자화, 결과값 : string
coffee.split("a"); //역할 : a를 기준으로 짤라서 리스트를  돌려줌, 결과값 : array
